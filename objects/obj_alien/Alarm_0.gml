...
if(obj_player.visible = true) {
	...
	if(abs(obj_player.x - x < 5) && fire = true && front = true && random(5) < 1) {
		...
		fire = false;
		alarm[1] = 30 - global.difficulty; // Fire delay set.
	}
}
// Alarm determines alien speed.
alien_speed = ((global.alien_count - (global.alien_count mod 10 + global.difficulty)) / 10) + 1;
